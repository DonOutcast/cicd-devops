  ...
  do
      ...
      do
        ...
        then
          ...
          grep $TEST1 > grep.txt
          DIFF_RES="$(diff -s s21_grep.txt  Makefile grep.txt)"
          ...
          TEST5="-e regex -e ^print s21_grep.c $var $var2 $var3  pattern.txt"
          echo "$TEST5"
          ...
          TEST6="-e while -e void s21_grep.c Makefile $var $var2 $var3  pattern.txt"
          echo "$TEST6"
